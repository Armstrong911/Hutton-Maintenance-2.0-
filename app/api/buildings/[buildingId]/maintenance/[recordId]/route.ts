...
export async function DELETE(req: NextRequest, { params }: { params: { buildingId: string; recordId: string } }) {
  ...
  await prisma.maintenanceRecord.delete({ where: { id: params.recordId } });
